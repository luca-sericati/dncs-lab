...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "router-1" do |router1|
    ...
    router1.vm.provision "shell", path: "provision/common.sh"
    router1.vm.provision "shell", path: "provision/router.sh"
    router1.vm.provision "shell", path: "provision/router-1.sh"
    router1.vm.provision "shell", path: "provision/runAlways/router-1_runAlways.sh", run: 'always'
  ...
  config.vm.define "router-2" do |router2|
    ...
    router2.vm.provision "shell", path: "provision/common.sh"
    router2.vm.provision "shell", path: "provision/router.sh"
    router2.vm.provision "shell", path: "provision/runAlways/router-2_runAlways.sh", run: 'always'
  ...
  config.vm.define "switch" do |switch|
    ...
    switch.vm.provision "shell", path: "provision/switch.sh"
    switch.vm.provision "shell", path: "provision/runAlways/switch_runAlways.sh", run: 'always'
  ...
  config.vm.define "host-a" do |hosta|
    ...
    hosta.vm.provision "shell", path: "provision/common.sh"
    hosta.vm.provision "shell", path: "provision/runAlways/host-a_runAlways.sh", run: 'always'
  ...
  config.vm.define "host-b" do |hostb|
    ...
    hostb.vm.provision "shell", path: "provision/common.sh"
    hostb.vm.provision "shell", path: "provision/runAlways/host-b_runAlways.sh", run: 'always'
  ...
  config.vm.define "host-c" do |hostc|
    ...
    hostc.vm.provision "shell", path: "provision/common.sh"
    hostc.vm.provision "shell", path: "provision/host-c.sh"
    hostc.vm.provision "shell", path: "provision/runAlways/host-c_runAlways.sh", run: 'always'
